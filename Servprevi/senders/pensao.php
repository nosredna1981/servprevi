...
<?php
		...
		if ($_SERVER['REQUEST_METHOD'] == "POST")  {
				...
				$relacao		= strtoupper($_POST['txtOpt2']);
				$falecido 		= strtoupper($_POST['txtNome2']);
				$cpf2 			= strtoupper($_POST['txtCpf2']);
				$num 			= strtoupper($_POST['txtNum']);
				$obito 			= strtoupper($_POST['txtObito']);
				...
				$mailer->setFrom('site@servprevi.com.br', 'Pensão'); //Obrigat�rio ser a mesma caixa postal indicada em "username"
				$mailer->addAddress('site@servprevi.com.br'); //Destinat�rios

				$mailer->Subject = "PENSÃO";
				$mailer->Body =    "<b>GÊNERO:</b> $genero <br/><br/>" .
								   "<b>NOME:</b> $nome <br/><br/>" .
								   "<b>DATA DE NASCIMENTO:</b> $nascimento <br/><br/>" .
								   "<b>CPF:</b> $cpf <br/><br/>" .
								   "<b>TELEFONE:</b> $tel <br/><br/>" .
								   "<b>RELAÇÃO COM O FALECIDO:</b> $relacao <br/><br/>" .
								   "<b>NOME DO FALECIDO:</b> $falecido <br/><br/>" .
								   "<b>CPF:</b> $cpf2 <br/><br/>" .
								   "<b>NÚMERO DO BENEFÍCIO:</b> $num <br/><br/>" .
								   "<b>DATA DO ÓBITO:</b> $obito <br/><br/>";
